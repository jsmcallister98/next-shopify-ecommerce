...
import { NavigationMenu } from "./NavPopover";
                  ...
                  <div className="flex flex-1 items-center justify-end">
                    <div className="flex items-center lg:ml-8">
                      ...
                      <div className="ml-4 flow-root lg:ml-8">
                        ...
                        >
                          <ShoppingBagIcon
                            className={`h-6 w-6 flex-shrink-0 ${textColor} group-hover:${textHoverColor}`}
                            aria-hidden="true"
                          />
                          <span
                            className={`ml-2 text-sm font-medium ${textColor} group-hover:${textHoverColor}`}
                          >
                            {cartQuantity}
                          </span>
